...
"alertCloseId"+this.idNum),this.alertCancelButton.innerHTML=this.alertCancelName,this.alertCancelButton.addEventListener("click",function(){a.hideAlert(a.alertCancelFunction)}),this.alertButtons.appendChild(this.alertCancelButton)));document.body.appendChild(this.alertOverlay);document.body.appendChild(this.alertBlock)};Alert.prototype.showAlert=function(){this.createAlert();this.alertOverlay.classList.add("showAlert");this.alertBlock.classList.add("showAlert")};
Alert.prototype.hideAlert=function(a){this.alertOverlay.classList.remove("showAlert");this.alertBlock.classList.remove("showAlert");this.alertOverlay.parentNode.removeChild(this.alertOverlay);this.alertBlock.parentNode.removeChild(this.alertBlock);(new Function("",a))()};