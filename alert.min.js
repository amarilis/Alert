...
Alert.prototype.hideAlert=function(a){this.alertOverlay.classList.remove("showAlert");this.alertBlock.classList.remove("showAlert");this.alertOverlay.parentNode.removeChild(this.alertOverlay);this.alertBlock.parentNode.removeChild(this.alertBlock);(new Function("",a))()};Alert.prototype.enterKey=function(a){document.addEventListener("keydown",function(b){document.getElementById(a.alertBlock.getAttribute("id"))&&(13===b.keyCode&&a.hideAlert(a.alertOkFunction),27===b.keyCode&&a.hideAlert(a.alertAfterFunction))})};